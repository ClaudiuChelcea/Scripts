...
function send_email(spreadsheet, participant_row, logo_BOS, logo_JEE_summer, conditions_pdf) {
  MailApp.sendEmail({
...
function get_body(NAME) {
  return "HTML body <img src=\"cid:sampleImage\" width=200 height=200><img src=\"cid:sampleImage2\" width=200 height=200>";
}
